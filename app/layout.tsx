import './globals.css';
import InboundInterceptor from '@/components/InboundInterceptor';
...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="en"><body>{children}<InboundInterceptor /></body></html>}
