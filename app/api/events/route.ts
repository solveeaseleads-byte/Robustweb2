...
const allowed=new Set(['search','tool_open','recommendation_click','lead_start','lead_submit','solution_click','feedback','tool_calculate','inbound_intercept','inbound_recommendation_click','inbound_dismiss']);
