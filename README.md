...
## Smart Inbound Interceptor
A non-blocking inbound intent layer detects explicit query/problem parameters and campaign/referrer context, maps the visit to the existing recommendation engine, and offers a relevant free tool. It avoids IP collection and email capture. Visitors can dismiss it, and interactions flow through the existing analytics pipeline.
